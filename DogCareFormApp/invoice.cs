...
public class Invoice
{
    ...
    public void GeneratePdfInvoice()
    {
        try
        {
            ...
            gfx.DrawString("Paw-Pal Dog Care Center", font, XBrushes.Black, new XRect(0, 0, page.Width.Point, 50), XStringFormats.Center);
            gfx.DrawString($"Your Pet ID: {PetID}", font, XBrushes.Black, new XRect(40, 80, page.Width.Point, 20), XStringFormats.TopLeft);
