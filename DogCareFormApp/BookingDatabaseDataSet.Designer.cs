...
namespace DogCareFormApp {
    ...
    public partial class BookingDatabaseDataSet : global::System.Data.DataSet {
        ...
        public partial class TableDataTable : global::System.Data.TypedTableBase<TableRow> {
            ...
            [global::System.Diagnostics.DebuggerNonUserCodeAttribute()]
            [global::System.CodeDom.Compiler.GeneratedCodeAttribute("System.Data.Design.TypedDataSetGenerator", "17.0.0.0")]
            public TableRow AddTableRow(int petID, string name, string service, string date) {
        ...
        public partial class TableRow : global::System.Data.DataRow {
            ...
            public int petID {
                get {
                    try {
                        return ((int)(this[this.tableTable.petIDColumn]));
                    }
                    catch (global::System.InvalidCastException e) {
                        throw new global::System.Data.StrongTypingException("The value for column \'petID\' in table \'Table\' is DBNull.", e);
                    }
                }
                set {
                    this[this.tableTable.petIDColumn] = value;
                }
            }
            ...
            public bool IspetIDNull() {
                return this.IsNull(this.tableTable.petIDColumn);
            }
            
            [global::System.Diagnostics.DebuggerNonUserCodeAttribute()]
            [global::System.CodeDom.Compiler.GeneratedCodeAttribute("System.Data.Design.TypedDataSetGenerator", "17.0.0.0")]
            public void SetpetIDNull() {
                this[this.tableTable.petIDColumn] = global::System.Convert.DBNull;
            }
...
namespace DogCareFormApp.BookingDatabaseDataSetTableAdapters {
    ...
    public partial class TableTableAdapter : global::System.ComponentModel.Component {
        ...
        private void InitAdapter() {
            ...
            this._adapter.DeleteCommand.CommandText = @"DELETE FROM [dbo].[Table] WHERE (([Id] = @Original_Id) AND ((@IsNull_petID = 1 AND [petID] IS NULL) OR ([petID] = @Original_petID)) AND ((@IsNull_name = 1 AND [name] IS NULL) OR ([name] = @Original_name)) AND ((@IsNull_service = 1 AND [service] IS NULL) OR ([service] = @Original_service)) AND ((@IsNull_date = 1 AND [date] IS NULL) OR ([date] = @Original_date)))";
            ...
            this._adapter.InsertCommand.CommandText = "INSERT INTO [dbo].[Table] ([petID], [name], [service], [date]) VALUES (@petID, @n" +
                "ame, @service, @date);\r\nSELECT Id, petID, name, service, date FROM [Table] WHERE" +
                " (Id = SCOPE_IDENTITY())";
            ...
            this._adapter.UpdateCommand.CommandText = @"UPDATE [dbo].[Table] SET [petID] = @petID, [name] = @name, [service] = @service, [date] = @date WHERE (([Id] = @Original_Id) AND ((@IsNull_petID = 1 AND [petID] IS NULL) OR ([petID] = @Original_petID)) AND ((@IsNull_name = 1 AND [name] IS NULL) OR ([name] = @Original_name)) AND ((@IsNull_service = 1 AND [service] IS NULL) OR ([service] = @Original_service)) AND ((@IsNull_date = 1 AND [date] IS NULL) OR ([date] = @Original_date)));
SELECT Id, petID, name, service, date FROM [Table] WHERE (Id = @Id)";
        ...
        private void InitConnection() {
            ...
            this._connection.ConnectionString = global::DogCareFormApp.Properties.Settings.Default.BookingDatabaseConnectionString;
        }
        ...
        private void InitCommandCollection() {
            ...
            this._commandCollection[0].CommandText = "SELECT Id, petID, name, service, date FROM dbo.[Table]";
        ...
        public virtual int Delete(int Original_Id, global::System.Nullable<int> Original_petID, string Original_name, string Original_service, string Original_date) {
        ...
        public virtual int Insert(global::System.Nullable<int> petID, string name, string service, string date) {
        ...
        public virtual int Update(global::System.Nullable<int> petID, string name, string service, string date, int Original_Id, global::System.Nullable<int> Original_petID, string Original_name, string Original_service, string Original_date, int Id) {
            if ((petID.HasValue == true)) {
            ...
            if ((Original_petID.HasValue == true)) {
                ...
                this.Adapter.UpdateCommand.Parameters[6].Value = ((int)(Original_petID.Value));
            }
            else {
        ...
        [global::System.ComponentModel.Design.HelpKeywordAttribute("vs.data.TableAdapter")]
        [global::System.ComponentModel.DataObjectMethodAttribute(global::System.ComponentModel.DataObjectMethodType.Update, true)]
        public virtual int Update(global::System.Nullable<int> petID, string name, string service, string date, int Original_Id, global::System.Nullable<int> Original_petID, string Original_name, string Original_service, string Original_date) {
            return this.Update(petID, name, service, date, Original_Id, Original_petID, Original_name, Original_service, Original_date, Original_Id);
        }
    }
